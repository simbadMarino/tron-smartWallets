...
//Test Goal: Go over each Requirement of a Smart Wallet TRC20/TRX contract and perform unit test (Happy path)
...
const contractAddress = process.env.SWTRXC_CONTRACT_ADDRESS;
...
describe("SmartWallet TRC20 / TRX Contract Tests", function () {
